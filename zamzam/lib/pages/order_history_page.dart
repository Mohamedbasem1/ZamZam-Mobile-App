  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<ShopOrder>>(
        stream: _orderService.getOrderHistory(), // Call the getOrderHistory function
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('Subtotal: EGP ${order.subtotal.toStringAsFixed(2)}'),
                              Text('Shipping: EGP ${order.shippingFee.toStringAsFixed(2)}'),
                            ],
                          ),
                          SizedBox(height: 8),
                          Text(
